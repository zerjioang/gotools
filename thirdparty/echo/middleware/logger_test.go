...
func TestLogger(t *testing.T) {
	...
	c = e.NewContext(req, rec)
	h = Logger()(func(c echo.Context) error {
		return c.String(codes.StatusTemporaryRedirect, "test")
	})
	h(c)
	...
	c = e.NewContext(req, rec)
	h = Logger()(func(c echo.Context) error {
		return c.String(codes.StatusNotFound, "test")
	})
	h(c)
...
func TestLoggerTemplate(t *testing.T) {
	...
	e.GET("/", func(c echo.Context) error {
		return c.String(codes.StatusOK, "Header Logged")
	})
...
func TestLoggerCustomTimestamp(t *testing.T) {
	...
	e.GET("/", func(c echo.Context) error {
		return c.String(codes.StatusOK, "custom time stamp test")
	})
