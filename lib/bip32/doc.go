...
* point(p): returns the coordinate pair resulting from EC point multiplication (repeated application of the EC group operation) of the secp256k1 common point with the integer p.
...
BenchmarkBip32/new-seed-4      			   	 1000000	      1901 ns/op	   0.53 MB/s	     256 B/op	       1 allocs/op
BenchmarkBip32/new-master-4      		 	  300000	      5141 ns/op	   0.19 MB/s	    1400 B/op	      14 allocs/op
BenchmarkBip32/new-child-key-600-4         	    5000	    322641 ns/op	   0.00 MB/s	    5125 B/op	      64 allocs/op
BenchmarkBip32/new-child-key-60000-4       	    5000	    320930 ns/op	   0.00 MB/s	    5127 B/op	      64 allocs/op
BenchmarkBip32/example-4                   	    1000	   1230789 ns/op	   0.00 MB/s	   11724 B/op	     162 allocs/op
