...
func TestExample(t *testing.T) {
	...
	departmentAuditKeys := map[string]*Key{}
	departmentAuditKeys["a"] = departmentKeys["a"].PublicKey()
	departmentAuditKeys["b"] = departmentKeys["b"].PublicKey()
	departmentAuditKeys["c"] = departmentKeys["c"].PublicKey()
	departmentAuditKeys["d"] = departmentKeys["d"].PublicKey()
