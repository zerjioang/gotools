...
func TestUnmarshalPubkey(t *testing.T) {
	...
	var (
		...
		dec    = &ecdsa.PublicKey{
			Curve: S256(),
			X:     fixtures.MustDecodeBig("0x760c4460e5336ac9bbd87952a3c7ec4363fc0a97bd31c86430806e287b437fd1"),
			Y:     fixtures.MustDecodeBig("0xb01abc6e1db640cf3106b520344af1d58b00b57823db3e1407cbc433e1b6d04d"),
		}
	)
...
func TestLoadECDSAFile(t *testing.T) {
	...
	checkKey := func(k *ecdsa.PrivateKey) {
		checkAddr(t, PubkeyToAddress(k.PublicKey), fixtures.HexToAddress(testAddrHex))
...
func TestValidateSignatureValues(t *testing.T) {
	...
	one := fixtures.Big1
	zero := fixtures.Big0
	secp256k1nMinus1 := new(big.Int).Sub(secp256k1N, fixtures.Big1)
...
func checkAddr(t *testing.T, addr0, addr1 fixtures.Address) {
	if addr0 != addr1 {
...
func TestPythonIntegration(t *testing.T) {
	...
	msg1 := fixtures.FromHex("00000000000000000000000000000000")
	sig1, _ := Sign(msg0, k0)
